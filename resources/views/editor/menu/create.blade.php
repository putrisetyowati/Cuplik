...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('editor.setting.menu.store')}}">
            ...
            <div class="mt-2">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="short" name="short" type="number" min="1" max="20" required placeholder="Add short" aria-label="Name">
            </div>  

            <div class="mt-2">
                <label class="block text-sm text-gray-900" for="name">Name</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" name="name" type="text" required="" placeholder="Add name" aria-label="Name">
            </div>  

            <div class="mt-2">
                <label class="block text-sm text-gray-900" for="link">Link</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="link" name="link" type="text" required="" placeholder="Add link" aria-label="Name">
            </div>  
