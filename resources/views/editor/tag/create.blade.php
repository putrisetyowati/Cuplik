...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('editor.setting.tag.store')}}">
            @csrf
            <p class="text-xl text-gray-800 font-semibold pb-4">Tambah Tag</p>

            <div class="mt-2">
                <label class="block text-sm text-gray-900" for="cus_name">Name</label>
