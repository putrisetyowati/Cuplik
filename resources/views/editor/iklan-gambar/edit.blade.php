...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('editor.iklan-gambar.update', $image_advertisement->id)}}" enctype="multipart/form-data">   
      @method('PUT')
        @csrf
            ...
            <div class="mt-6">
                ...
                <a href="{{route('editor.iklan-gambar.index')}}" class="px-4 py-1 text-white font-light tracking-wider bg-red-700 rounded">Batal</a>
            </div>
