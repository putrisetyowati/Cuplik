...
<div class="w-full mt-12">
    <div class="grid grid-cols-3 gap-4 mb-4">
        <div>
            ...
            <i class="fas fa-list mr-3"></i> Berita
            </p>
        </div>
        <div class="col-span-2 place-self-end">
            <a href="{{route('editor.news.create')}}" class="rounded bg-cyan-500 hover:bg-cyan-700 py-2 px-4 text-white transition duration-300 font-semibold">+ Tambah Data</a>
        </div>
    </div>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody class="text-gray-700">
                ...
                <tr>
                    ...
                    <a href="{{ url('editor/news')}}/{{ $data->id }}/{{ 'edit' }}">
                        <div
                    ...
                    <form action="{{url('editor/news')}}/{{$data->id}}" method="post">
                        @method('DELETE')
                        @csrf
                        <button type="submit"
