@extends('editor.app')
@section('title','Tambah Iklan Baris')
@section('content')
...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('editor.iklan-baris.store')}}">
           @csrf
        <p class="text-xl text-gray-800 font-semibold pb-4">Tambah Iklan Baris</p>
            ...
            <div class="mt-6">
                ...
                <a href="{{route('editor.iklan-baris.index')}}" class="px-4 py-1 text-white font-light tracking-wider bg-red-700 rounded">Batal</a>
            </div>
