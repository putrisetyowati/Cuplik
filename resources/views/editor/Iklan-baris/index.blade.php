...
<div class="grid grid-cols-3 gap-4 mb-4">
        ...
        <div class="col-span-2 place-self-end">
            <a href="{{route('editor.iklan-baris.create')}}" class="rounded bg-cyan-500 hover:bg-cyan-700 py-2 px-4 text-white transition duration-300 font-semibold">+ Tambah Data</a>
        </div>
    </div>
                    ...
                    <a href="{{ url('editor/iklan-baris')}}/{{ $data->id }}/{{ 'edit' }}">
                        <div
                    ...
                    <form action="{{url('editor/iklan-baris')}}/{{$data->id}}" method="post">
                        @method('DELETE')
                        @csrf
                        <button type="submit"
