...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('editor.iklan-baris.update', $line_advertisement->id)}}">
        @method('PUT')
           @csrf
            ...
            <div class="grid flex justify-between grid-cols-1 gap-4 my-3">
                ...
                <div class="col-span-5">
                    <textarea id="content" name="content"
                        ...
                        rows="8">{{old('content', $line_advertisement->content)}}
                    </textarea>
