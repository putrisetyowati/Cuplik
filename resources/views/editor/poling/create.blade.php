...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl">
            <p class="text-xl text-gray-800 font-semibold pb-4">Tambah Poling</p>
            ...
            <div class="mt-6">
                ...
                <a href="{{route('admin.poling.index')}}" class="px-4 py-1 text-white font-light tracking-wider bg-red-700 rounded">Batal</a>
            </div>
