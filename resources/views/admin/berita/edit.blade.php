...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action= "{{route('admin.news.update', $news->id)}}">
       @method('PUT')
        @csrf   
        <p class="text-xl text-gray-800 font-semibold pb-4">Edit Berita</p>
            ...
            <div class="mt-2">
                ...
                <div class="relative w-full py-1 text-gray-700 rounded">
                    <select id="menu_id"
                        class="block p-2 w-full bg-gray-200 appearance-none focus:outline-none {{ $errors->has('menu_id') ? 'is-invalid' : '' }} " id="menu_id" name="menu_id" required="" value="{{old('title', $news->id)}}"
            ...
            <div class="col-span-5">
                <textarea id="content" name="content"
                    ...
                    rows="8">value="{{old('content', $news->content)}}"
                </textarea>
