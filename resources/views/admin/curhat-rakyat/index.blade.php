@extends('admin.app')
@section('title','Curhat Rakyat')
@section('content')
<div class="w-full mt-12">
    <div class="grid grid-cols-3 gap-4 mb-4">
        <div>
            <p class="text-xl pb-3 flex items-center">
            <i class="fas fa-list mr-3"></i> Curhat Rakyat
            </p>
        </div>
        <div class="col-span-2 place-self-end">
            <a href="{{route('admin.curhat-rakyat.create')}}" class="rounded bg-cyan-500 hover:bg-cyan-700 py-2 px-4 text-white transition duration-300 font-semibold">+ Tambah Data</a>
        </div>
    </div>
