@extends('admin.app')
@section('title','Posisi Iklan')
@section('content')
<div class="w-full mt-12">
    <div class="grid grid-cols-3 gap-4 mb-4">
        <div>
            <p class="text-xl pb-3 flex items-center">
            <i class="fas fa-list mr-3"></i> Posisi Iklan
            </p>
        </div>
        <div class="col-span-2 place-self-end">
            <a href="{{route('admin.setting.posisi-iklan.create')}}" class="rounded bg-cyan-500 hover:bg-cyan-700 py-2 px-4 text-white transition duration-300 font-semibold">+ Tambah Data</a>
        </div>
    </div>
    ...
    <div class="bg-white overflow-auto">
        <table class="min-w-full bg-white">
            ...
            <tbody class="text-gray-700">
                    ...
                    <a href="{{ url('admin/setting/posisi-iklan')}}/{{ $data->id }}/{{ 'edit' }}">
                        <div
                    ...
                    <form action="{{url('admin/setting/posisi-iklan')}}/{{$data->id}}" method="post">
                        @method('DELETE')
                        @csrf
                        <button type="submit"
