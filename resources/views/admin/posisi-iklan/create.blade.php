...
<div class="w-full mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('admin.setting.posisi-iklan.store')}}">
            @csrf
            ...
            <div class="mt-2">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="sortir" name="sortir" type="number" required="" max="20" min="1" placeholder="Insert NUmber" aria-label="Name">
            </div>  

            <div class="mt-2">
                <label class="block text-sm text-gray-900" for="lebar">Lebar (pixel)</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="lebar" name="lebar" type="number" max="500" min="" required="" placeholder="Insert Number" aria-label="Name">
            </div>  

            <div class="mt-2">
                <label class="block text-sm text-gray-900" for="tinggi">Tinggi (pixel)</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="tinggi" name="tinggi" type="number" max="500" min="" required="" placeholder="Insert Number" aria-label="Name">
            </div> 
