    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('admin.setting.tag-sub.store')}}">
            ...
            <div class="mt-2">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="short" name="short" type="number" required="" placeholder="" aria-label="Name">
            </div>  
            ...
            <div class="mt-6">
                ...
                <a href="{{route('admin.setting.tag-sub.create')}}" class="px-4 py-1 text-white font-light tracking-wider bg-red-700 rounded">Batal</a>
            </div>
