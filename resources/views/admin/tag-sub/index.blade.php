...
<div class="w-full mt-12">
    <div class="grid grid-cols-3 gap-4 mb-4">
        ...
        <div class="col-span-2 place-self-end">
            <a href="{{route('admin.setting.tag-sub.create')}}" class="rounded bg-cyan-500 hover:bg-cyan-700 py-2 px-4 text-white transition duration-300 font-semibold">+ Tambah Data</a>
        </div>
    </div>
                    ...
                    <a href="{{ url('admin/setting/tag-sub')}}/{{ $data->id }}/{{ 'edit' }}">
                        <div
                    ...
                    <form action="{{url('admin/setting/tag-sub')}}/{{$data->id}}" method="post">
                        @method('DELETE')
                        @csrf
                        <button type="submit"
