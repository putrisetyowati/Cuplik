...
class CovidController extends Controller
{
    ...
    {
        $covid = Covid::all();
        return view ('editor.covid.index')->with('covid', $covid);
    }
    ...
    {
        return view ('editor.covid.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('editor/covid-19')->with('status', 'Covid created!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('editor.covid.edit')->with('covid', $covid);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('editor/covid-19')->with('status', 'Data Covid update!');
    }
