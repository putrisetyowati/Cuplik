...
class LineAdvertisementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('editor.iklan-baris.index')->with('line_advertisement', $line_advertisement);
    }
    ...
    {
        return view ('editor.iklan-baris.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('editor/iklan-baris')->with('status', 'Iklan Baris created!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('editor.Iklan-baris.edit')->with('line_advertisement', $line_advertisement);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('editor/iklan-baris')->with('status', 'Iklan Baris Update!');
    }
