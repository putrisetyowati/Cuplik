...
class RegisterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('editor.register.index')    
    ...
    {
        return view ('editor.register.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('editor/setting/register')->with('status', 'register created!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('editor.register.edit')->with('register', $register);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('editor/setting/register')->with('status', 'Register Update!');
    }
