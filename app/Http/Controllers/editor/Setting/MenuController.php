...
class MenuController extends Controller
{
    ...
    {
        return view ('editor.menu.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('editor/setting/menu')->with('status', 'Menu created!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('editor.menu.edit')->with('menu', $menu);
    }
